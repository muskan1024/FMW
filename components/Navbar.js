...
function Navbar() {
    ...
    return(
        <header className="shadow-lg shadow-white py-2 bg-black">
            <div className="flex items-center justify-between xl:max-w-7xl mx-auto max-w-full  px-8 flex-wrap w-full">
                <a href="/" ><img src="images/fmw-logo-1.png" width={220} height={55} /></a>
                ...
                <nav className={`${open ? "block" : "hidden"} w-full lg:flex lg:items-center lg:w-auto`} >
                    <ul className="text-base text-white flex justify-evenly">
                        ...
                        <li>
                            <a href="#" className="lg:px-5 py-2 hover:text-blue-400 font-semibold">About</a>
                        </li>
                    </ul>
                </nav>
            </div>
